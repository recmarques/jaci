...
?>
  ...
  <html lang="en" dir="ltr">
    <head>
      ...
      <link rel="stylesheet" href="css/style-avaliacao.css">
  ...
  <div class="form">
    <div class="titulo">
      ...
      <div class="descricao">
          ...
          definir projetos de alta qualidade para todos!
      </div>
    </div>

    <div class="form-cadastro">
      <form method="post" class="login-form" action="controller/avaliar-projeto.php?ID_Projeto=<?php echo $ID_Projeto;?>"> 
      ...
      <div class="titulo-autor-projeto">
        ...
        POR <?php echo $Nome; ?>
            ...
            <br /><br />
              <p class="categoria categoria-titulo">Nível de satisfação</p>
            <br /><br />
            
            <div class="range">
              <div class="sliderValue">
                <span class="sliderValue-span">10</span>
              </div>

              <div class="field">
                <div class="value left">Baixo</div>
                  <input type="range" class="input-value" name="nota" id="nota" min="0" max="10" value="5" steps="1">
            ...
            <br /><br />
              <input type="submit" class="logbtn" value="ENVIAR AVALIAÇÃO" name="btn-entrar">
            <br />
